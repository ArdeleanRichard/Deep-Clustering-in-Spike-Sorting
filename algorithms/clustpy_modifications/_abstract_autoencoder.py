...
class FullyConnectedBlock(torch.nn.Module):
    ...
    def __init__(self, layers: list, batch_norm: bool = True, dropout: float = None,
        ...
        # for layer in fc_block_list:
        #     # print(layer)
        #     if isinstance(layer, torch.nn.Linear) and (layer.out_features != layers[-1] and layer.out_features != layers[0]):
        #         # print(layer)
